  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
        ...
        >
            ...
            <Link href="https://www.linkedin.com/in/manojkumar--c/" className="mx-2">About</Link>
            <Link href="mailto:contact.manojchandran@gmail.com" className="mx-2">Contact</Link>
